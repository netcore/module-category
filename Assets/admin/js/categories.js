...
new Vue({
    ...
    created: function created() {
        ...
        this.$on('jsTree.orderChanged', function (treeJson) {
            __WEBPACK_IMPORTED_MODULE_1_axios___default.a.post(window.categoryModule.routes.order, treeJson).catch(function (err) {
    ...
    methods: {
         ...
         * Save category
         */
        __categoryApp__saveCategory: function __categoryApp__saveCategory(event) {
            ...
            __WEBPACK_IMPORTED_MODULE_1_axios___default.a.post(route, data).then(function (res) {
    ...
    components: {
        'categories-tree': __webpack_require__(33),
...
if (Component.options.functional) {console.error("[vue-loader] CategoriesTree.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-930d6abe", Component.options)
  } else {
    hotAPI.reload("data-v-930d6abe", Component.options)
  }
